    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (val && val.image) {
          ...
          setData(
            "https://imgs.search.brave.com/WzsJxrd95PAh6aWhwpATikTtTAnHJl_xX00Luqxvp_U/rs:fit:860:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzAzLzQwLzEyLzQ5/LzM2MF9GXzM0MDEy/NDkzNF9iejNwUVRM/cmRGcEg5MmVra251/YVRIeThKdVhnRzdm/aS5qcGc"
          );
        }
      } catch (error) {
        // alert(error.message);
          ...
          <nav className="flex justify-between items-center w-[92%] mx-auto">
            ...
            <div>
              ...
              <li className="relative">
                ...
                {loggedin && (
                  <li className="relative">
                  <a className="hover:text-gray-500" href="/mydreams">My Dreams</a>
                </li>
                )}
                <li className="relative">
                  <a className="hover:text-gray-500" href="javascript:void(0)">About</a>
